...
<section id="image" style=" height: 1120px; ">
  <div class=" card-img-overlay ">
    <div
      class=" card col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-3  "
        ...
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <select name="bus" id="bus" required>
              <option value="<?php echo $row['bus']; ?>" selected ><?php echo $row['bus']; ?></option>
              <?php
              include_once("./db_con.php");
          ...
          <div class="form-group">
            ...
            <input type="text" name="unm" class="form-control" value="<?php echo $row['name']; ?>"
              placeholder="Enter Costumer Name" />
          </div>
          <div class="form-group">
            <label for="Contact Number">Contact Number:</label>
            <input type="tel" name="num" class="form-control" value="<?php echo $row['contact']; ?>"
              placeholder="Enter Contact Number" />
          </div>
          <div class="form-group">
            <label for="From">From :</label>
            <input type="text" name="from" value="<?php echo $row['city1']; ?>" class="form-control"
              placeholder="Enter Via City" />
          </div>
          <div class="form-group">
            <label for="To">To :</label>
            <input type="text" name="to" value="<?php echo $row['city2']; ?>" class="form-control"
              placeholder="Costumer destination" />
          </div>
          <div class="form-group">
            ...
            <div class="mb-3">
              <div class="container" id="seat">
                ...
                <div class="row mb-3 ">
                  ...
                  <div class="col-lg-6 col-md-4 col-sm-4 ">
                    <button class="btn btn-info" style=" width: 50px; height: 40px; " id="1"
                      onclick="fun(28)">29</button>
                    <button class="btn btn-info" style=" width: 50px; height: 40px; " id="1"
                      onclick="fun(29)">28</button>
                    <button class="btn btn-info" style=" width: 50px; height: 40px; " id="1"
                ...
                <div class="row">
                  ...
                  <input type="number" name="seat_no" class="form-control" id="seat_no" placeholder="Enter Seat Number"
                    value="<?php echo $row['seat']; ?>" onclick="fun()" readonly >
                </div>
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <input type="number" name="amount" value="<?php echo $row['price']; ?>" class="form-control" id="amount"
